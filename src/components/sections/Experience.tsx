...
const EXPERIENCE_ITEMS: ExperienceItem[] = [
  {
    ...
    brief: 'Architected legacy monolith migration to React 19, cut bundle sizes by 40%, and led frontend delivery of accessible WCAG lending features.',
  ...
  },
  {
    ...
    brief: 'Partnered with Ernst & Young (EY) to design multi-tenant audit/compliance SaaS applications, leading accessibility standards and RTL/Jest testing adoption.',
  ...
  },
  {
    ...
    brief: 'Engineered a highly dynamic JSON-driven form creation system and built scalable React/Redux integrations for US and EU markets.',
  ...
  },
  {
    ...
    period: '2019 – Present',
    brief: 'Designing high-performance canvas frameworks, component-driven microfrontends, and custom developer utilities.',
    highlights: [
